    ...
    <div className="sm:w-[288px] w-full rounded-[15px] bg-[#edeef0] cursor-pointer" onClick={handleClick}>
      ...
      <div className="flex flex-col p-4">
        <div className="flex flex-row items-center mb-[18px]">
          ...
          <p className="ml-[12px] mt-[2px] font-epilogue font-medium text-[12px] text-[#333333]">Education</p>
        </div>
        ...
        <div className="flex justify-between flex-wrap mt-[15px] gap-2">
          <div className="flex flex-col">
            <h4 className="font-epilogue font-semibold text-[14px] text-[#91929b] leading-[22px]">{amountCollected}</h4>
          ...
          <div className="flex flex-col">
            <h4 className="font-epilogue font-semibold text-[14px] text-[#9a9ba3] leading-[22px]">{remainingDays}</h4>
